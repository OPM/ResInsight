...
- **[docs/agents/workflow.md](docs/agents/workflow.md)** - Safety guidelines and output expectations

These documents contain the authoritative information about the project. Always consult them when working on code.

Use `report_progress` to report progress frequently while working.