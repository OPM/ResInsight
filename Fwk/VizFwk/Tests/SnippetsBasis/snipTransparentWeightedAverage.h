...
//
//==================================================================================================
class TransparentWeightedAverage : public TestSnippet
{
    CVFU_DECLARE_SNIPPET("TransparentWeightedAverage");

public:
    TransparentWeightedAverage();
