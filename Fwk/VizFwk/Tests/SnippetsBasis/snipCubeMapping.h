...
//
//==================================================================================================
class CubeMapping : public TestSnippet
{
...
private:
    void                    loadCubeMapImages(ref<TextureImage> cubeImages[6]) const;
    ref<Texture>            loadCubeMapTexture() const;
    void                    addDebugCubeWithCubeMapImages();
    static ref<DrawableGeo> createTexturedQuad(const Vec3f& origin, const Vec3f& u, const Vec3f& v);
    static ref<Part>        createTexturedPart(DrawableGeo* geo, TextureImage* texImg);
    static ref<DrawableGeo> createTeapot();
