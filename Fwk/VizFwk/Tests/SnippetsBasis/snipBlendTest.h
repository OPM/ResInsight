...
//
//==================================================================================================
class BlendTest: public TestSnippet
{
    CVFU_DECLARE_SNIPPET("Blending tests");
...
private:
    ...
    float                       m_opacity;
    ref<RenderStateDepth>                  m_depth;
    ref<RenderStateBlending>    m_blending;
    ref<RenderStateCullFace>               m_cullFace;
};
