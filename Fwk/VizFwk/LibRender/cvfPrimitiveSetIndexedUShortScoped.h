...
//
//==================================================================================================
class PrimitiveSetIndexedUShortScoped : public PrimitiveSet
{
public:
    PrimitiveSetIndexedUShortScoped(PrimitiveType primitiveType);
    virtual ~PrimitiveSetIndexedUShortScoped();
    ...
    void                setIndices(UShortArray* indices, size_t firstElement, size_t elementCount);
