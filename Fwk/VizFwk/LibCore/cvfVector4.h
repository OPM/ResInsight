...
// Required by c++20 
template <> const Vector4<float> Vector4<float>::UNDEFINED;
template <> const Vector4<double> Vector4<double>::UNDEFINED;
template <> const Vector4<int> Vector4<int>::UNDEFINED;
