...
QString caf::PdmPythonGenerator::generate( PdmObjectFactory* factory, std::vector<QString>& errorMessages ) const
{
    ...
    for ( const QString& classKeyword : classKeywords )
    {
        ...
        auto* object       = dynamic_cast<PdmObject*>( objectHandle );
        CAF_ASSERT( object );
    ...
    out << "from typing import Union, Dict\n";
    ...
    out << "  }\n";
    out << "  return _class_dict\n\n";

    out << "def class_from_keyword(class_keyword: str) -> Union[PdmObjectBase, None]:\n";
