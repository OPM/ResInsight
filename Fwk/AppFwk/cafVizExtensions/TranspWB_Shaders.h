...
static const char TranspWB_CombinationFrag_inl[] =
    ...
    "                        \n"
    "    resultColor = vec4(sumWColorPrSumWAlpha - productOneMinusAlpha * sumWColorPrSumWAlpha + productOneMinusAlpha "
    "* opaceColor.rgb, 1.0);  \n"
    "                                                                                                                  "
    "                        \n"
...
static const char TranspWB_TransparentPartsFrag_inl[] =
    ...
    "  \n"
    "    return alpha * max(1e-2, min(3e3, 10 / (1e5 + pow(zDepth/10, 3) + pow(zDepth/200, 6) ))); // Proposed by "
    "paper  \n"
    "    //return zDepth;                                                                                              "
    "  \n"
    "}                                                                                                                 "
