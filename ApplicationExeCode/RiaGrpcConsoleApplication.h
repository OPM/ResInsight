...
class RiaGrpcConsoleApplication : public RiaConsoleApplication, public RiaGrpcApplicationInterface
{
    Q_OBJECT

public:
    RiaGrpcConsoleApplication( int& argc, char** argv );
    ~RiaGrpcConsoleApplication();
