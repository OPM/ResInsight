...
QwtText RiuQwtCurvePointTracker::trackerText(const QPoint& pos) const
{
    ...
    if (m_plot)
    {
        ...
        {
            QString str =
                !curveInfoText.isEmpty() ? QString("%1: %2").arg(curveInfoText).arg(valueAxisValueString) : valueAxisValueString;
                                                   ...
                                                   QwtPlot::Axis* relatedYAxis) const
{
    ...
    {
        const QwtScaleDraw* mainAxisScaleDraw =
            m_isMainAxisHorizontal ? m_plot->axisScaleDraw(*relatedXAxis) : m_plot->axisScaleDraw(*relatedYAxis);
    ...
    {
        const QwtScaleDraw* valueAxisScaleDraw =
            m_isMainAxisHorizontal ? m_plot->axisScaleDraw(*relatedYAxis) : m_plot->axisScaleDraw(*relatedXAxis);
