...
///
//--------------------------------------------------------------------------------------------------
std::string RiuSummaryVectorDescriptionMap::vectorLongName(const std::string& vectorName, bool returnVectorNameIfNotFound)
{
...
void RiuSummaryVectorDescriptionMap::populateFieldToInfoMap()
{
    ...
    m_summaryToDescMap = {
        ...
        {"FWSSP",
         {A::SUMMARY_FIELD,
          "Period for which target sustainable rate could be maintained for the most recent sustainable capacity test for "
          "water"}},
        ...
        {"GWIRNB",
         {A::SUMMARY_WELL_GROUP, "Water flow rate along the group’s or node’s inlet branch in the water injection network"}},
        {"GGIRNB",
        ...
        {"WHDF",
         {A::SUMMARY_WELL,
          "Hydraulic head in well based on the reference depth given in HYDRHEAD and the well’s reference depth calculated at "
