...
void RiuMainWindow::createActions()
{
    ...
    m_drawStyleFaultLinesSolidAction = new QAction( QIcon( ":/DrawStyleFaultMesh.svg" ), "Fault Mesh And Surfaces", this );
    m_dsActionGroup->addAction( m_drawStyleFaultLinesSolidAction );

    m_drawStyleHideGridCellsAction = new QAction( QIcon( ":/DrawStyleHideCells.svg" ), "&Hide Grid Cells", this );
    ...
    m_toggleFaultsLabelAction = new QAction( QIcon( ":/DrawStyleFaultLabels.svg" ), "&Show Fault Labels", this );
    ...
    m_showWellCellsAction = new QAction( QIcon( ":/DrawStyleWellCells.svg" ), "&Show Well Cells", this );
