...
void RiuGuiTheme::preparseStyleSheet( RiaDefines::ThemeEnum theme, QString& styleSheet )
{
    ...
    colorRoleMap.insert( "Background", QPalette::ColorRole::Background );
    ...
    colorRoleMap.insert( "Foreground", QPalette::ColorRole::Foreground );
    ...
    colorRoleMap.insert( "PlaceholderText", QPalette::ColorRole::PlaceholderText );
