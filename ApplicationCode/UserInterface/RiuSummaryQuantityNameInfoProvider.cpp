...
void RiuSummaryQuantityNameInfoProvider::populateFieldToInfoMap()
{
    ...
    m_summaryToDescMap.insert( { "FGSRL",
                                 { A::SUMMARY_FIELD,
    ...
    m_summaryToDescMap.insert( { "FOSRL",
                                 { A::SUMMARY_FIELD,
                                   "Maximum tested rate sustained for the test period during the most recent "
    ...
    m_summaryToDescMap.insert( { "FWSRL",
                                 { A::SUMMARY_FIELD,
                                   "Maximum tested rate sustained for the test period during the most recent "
    ...
    m_summaryToDescMap.insert( { "FWSRU",
                                 { A::SUMMARY_FIELD,
                                   "Minimum tested rate not sustained for the test period during the most recent "
                                   "sustainable capacity test for water" } } );
    m_summaryToDescMap.insert( { "FWSSP",
                                 { A::SUMMARY_FIELD,
                                   "Period for which target sustainable rate could be maintained for the most recent "
    ...
    m_summaryToDescMap.insert(
        { "GGSPR",
          { A::SUMMARY_WELL_GROUP, "Target sustainable rate for most recent sustainable capacity test for gas" } } );
    m_summaryToDescMap.insert(
        { "GGSRL",
    ...
    m_summaryToDescMap.insert( { "GGSRU",
                                 { A::SUMMARY_WELL_GROUP,
                                   "Minimum tested rate not sustained for the test period during the most recent "
                                   "sustainable capacity test for "
                                   "gas" } } );
    m_summaryToDescMap.insert( { "GGSSP",
                                 { A::SUMMARY_WELL_GROUP,
                                   "Period for which target sustainable rate could be maintained for the most recent "
                                   "sustainable capacity test "
                                   "for gas" } } );
    ...
    m_summaryToDescMap.insert(
        { "GOSPR",
          { A::SUMMARY_WELL_GROUP, "Target sustainable rate for most recent sustainable capacity test for oil" } } );
    m_summaryToDescMap.insert(
        { "GOSRL",
          { A::SUMMARY_WELL_GROUP,
            "Maximum tested rate sustained for the test period during the most recent sustainable "
            "capacity test for oil" } } );
    m_summaryToDescMap.insert( { "GOSRU",
                                 { A::SUMMARY_WELL_GROUP,
                                   "Minimum tested rate not sustained for the test period during the most recent "
                                   "sustainable capacity test for "
                                   "oil" } } );
    m_summaryToDescMap.insert( { "GOSSP",
                                 { A::SUMMARY_WELL_GROUP,
                                   "Period for which target sustainable rate could be maintained for the most recent "
                                   "sustainable capacity test "
                                   "for oil" } } );
    ...
    m_summaryToDescMap.insert( { "GWSRU",
                                 { A::SUMMARY_WELL_GROUP,
                                   "Minimum tested rate not sustained for the test period during the most recent "
                                   "sustainable capacity test for "
                                   "water" } } );
    m_summaryToDescMap.insert( { "GWSSP",
                                 { A::SUMMARY_WELL_GROUP,
                                   "Period for which target sustainable rate could be maintained for the most recent "
                                   "sustainable capacity test "
                                   "for water" } } );
    ...
    m_summaryToDescMap.insert(
        { "WHD",
          { A::SUMMARY_WELL, "Hydraulic head in well based on the reference depth given in HYDRHEAD and the well’s reference depth" } } );
    m_summaryToDescMap.insert(
        { "WHDF",
          { A::SUMMARY_WELL,
    ...
    m_summaryToDescMap.insert( { "COFRU",
    ...
    m_summaryToDescMap.insert( { "CGFRU",
                                 { A::SUMMARY_WELL_COMPLETION,
