...
///
//--------------------------------------------------------------------------------------------------
void RimFractureModelTemplateCollection::updateFilePathsFromProjectPath( const QString& newProjectPath,
                                                                         const QString& oldProjectPath )
{
    // for ( RimFractureModelTemplate* f : m_fractureModelTemplates() )
    // {
    //     f->updateFilePathsFromProjectPath( newProjectPath, oldProjectPath );
    // }
}
