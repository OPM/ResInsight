...
RimWbsParameters::RimWbsParameters()
{
    ...
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_porePressureSource,
    ...
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_porePressureNonReservoirSource,
                                               "PorePressureNonReservoirSource",
                                               "Non-Reservoir Pore Pressure",
                                               "",
                                               "Data source for Non-Reservoir Pore Pressure",
                                               "" );
    CAF_PDM_InitScriptableValueField( &m_userDefinedPPShale,
                                      "UserPPNonReservoir",
                                      1.05,
    ...
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_poissonRatioSource,
                                               "PoissionRatioSource",
                                               "Poisson Ratio",
                                               "",
    ...
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_ucsSource,
                                               "UcsSource",
    ...
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_OBG0Source,
                                               "OBG0Source",
                                               "Initial Overburden Gradient",
                                               "",
                                               "Data source for OBG0",
                                               "" );
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_DFSource,
                                               "DFSource",
                                               "Depletion Factor (DF)",
                                               "",
    ...
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_K0SHSource,
                                               "K0SHSource",
                                               "K0_SH",
                                               "",
    ...
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_FGShaleSource, "FGShaleSource", "FG in Shale Calculation", "", "", "" );
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_K0FGSource,
                                               "K0FGSource",
                                               "K0_FG",
                                               "",
    ...
    CAF_PDM_InitScriptableValueField( &m_userDefinedPoissionRatio,
                                      "UserPoissonRatio",
                                      0.35,
    ...
    CAF_PDM_InitScriptableValueField( &m_userDefinedUcs,
                                      "UserUcs",
                                      100.0,
    ...
    CAF_PDM_InitScriptableValueField( &m_userDefinedDF, "UserDF", 0.7, "User Defined DF", "", "User Defined Depletion Factor", "" );
    CAF_PDM_InitScriptableValueField( &m_userDefinedK0FG, "UserK0FG", 0.75, "User Defined K0_FG", "", "", "" );
    CAF_PDM_InitScriptableValueField( &m_userDefinedK0SH, "UserK0SH", 0.65, "User Defined K0_SH", "", "", "" );
    CAF_PDM_InitScriptableValueField( &m_FGShaleMultiplier,
                                      "FGMultiplier",
                                      1.05,
    ...
    CAF_PDM_InitScriptableValueField( &m_userDefinedDensity,
                                      "WaterDensity",
                                      1.03,
