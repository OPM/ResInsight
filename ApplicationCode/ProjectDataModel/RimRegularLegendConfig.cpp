...
void RimRegularLegendConfig::updateLegend()
{
    ...
    if (m_mappingMode == LOG10_CONTINUOUS || m_mappingMode == LOG10_DISCRETE)
    {
        ...
        decadesInRange =
            cvf::Math::abs(adjustedMin) < cvf::Math::abs(adjustedMax) ? cvf::Math::abs(adjustedMin) : cvf::Math::abs(adjustedMax);
                                                                            ...
                                                                            bool*                      useOptionsOnly)
{
    ...
    else if (fieldNeedingOptions == &m_rangeMode)
    {
        ...
        {
            options.push_back(caf::PdmOptionItemInfo(RangeModeEnum::uiText(RimRegularLegendConfig::AUTOMATIC_CURRENT_TIMESTEP),
