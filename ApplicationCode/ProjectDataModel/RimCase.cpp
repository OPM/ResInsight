    ...
    : m_isInActiveDestruction( false )
{
    ...
    CAF_PDM_InitScriptableValueField( &caseUserDescription, "Name", QString(), "Case Name", "", "", "" );
    caseUserDescription.registerKeywordAlias( "CaseUserDescription" );

    CAF_PDM_InitScriptableValueField( &caseId, "Id", -1, "Case ID", "", "", "" );
    ...
    CAF_PDM_InitScriptableValueFieldNoDefault( &m_caseFileName, "FilePath", "Case File Name", "", "", "" );
