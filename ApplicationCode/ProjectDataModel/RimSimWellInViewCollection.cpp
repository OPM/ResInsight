...
RimSimWellInViewCollection::RimSimWellInViewCollection()
{
    ...
    CAF_PDM_InitField(&showWellsIntersectingVisibleCells,
                      ...
                      "",
                      "");
    // CAF_PDM_InitField(&showWellsIntersectingVisibleCells, "ShowWellsIntersectingVisibleCells", false, "Hide Wells Missing
    // Visible Cells", "", "", "");
    ...
    CAF_PDM_InitField(
        &wellCellFenceType, "DefaultWellFenceDirection", WellFenceEnum(K_DIRECTION), "Well Fence Direction", "", "", "");
    ...
    CAF_PDM_InitField(&isAutoDetectingBranches,
                      ...
                      "branch, and thus is starting from wellhead",
                      "");
    CAF_PDM_InitField(
        &wellHeadPosition, "WellHeadPosition", WellHeadPositionEnum(WELLHEAD_POS_TOP_COLUMN), "Well Head Position", "", "", "");
...
{
    if (m_framesOfResultWellPipeVisibilities.size() > frameIndex && m_framesOfResultWellPipeVisibilities[frameIndex].size())
        return;
