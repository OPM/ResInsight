...
{
    std::vector<cvf::Vec3d> wellPathPoints = wellPath->m_wellPathPoints;
    std::vector<double>     measuredDepths = wellPath->m_measuredDepths;
    ...
    if ( !firstPointAtSeaLevel )
    {
        ...
        wellPath->m_wellPathPoints = newPoints;
        ...
        wellPath->m_measuredDepths = newMeasuredDepths;
    }
}
