...
public:
    TestCommand1()
    {
        CAF_PDM_InitScriptableValueField( &m_textArgument, "TextArgument", QString(), "TextArgument", "", "", "" );
        CAF_PDM_InitScriptableValueField( &m_doubleArgument, "DoubleArgument", 0.0, "DoubleArgument", "", "", "" );
        CAF_PDM_InitScriptableValueField( &m_intArgument, "IntArgument", 0, "IntArgument", "", "", "" );
...
public:
    TC2()
    {
        CAF_PDM_InitScriptableValueField( &m_textArgument, "ta", QString(), "TextArgument", "", "", "" );
        CAF_PDM_InitScriptableValueField( &m_doubleArgument, "da", 0.0, "DoubleArgument", "", "", "" );
        CAF_PDM_InitScriptableValueField( &m_intArgument, "ia", 0, "IntArgument", "", "", "" );
