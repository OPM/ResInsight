...
TEST(RigCellGeometryTools, calculateCellVolumeTest)
{
    ...
    overlapVertices;
    RigCellGeometryTools::estimateHexOverlapWithBoundingBox(
        cornerVertices, tetrahedronBBox, &overlapVertices, &overlapBoundingBox);
...
TEST(RigCellGeometryTools, calculateCellVolumeTest2)
{
    ...
    RigCellGeometryTools::estimateHexOverlapWithBoundingBox(
        cornerVertices, smallerInnerBBox, &overlapVertices, &overlapBoundingBox);
...
{
    {
        ...
        std::vector<cvf::Vec3d> wellPathPoints    = {
            {50.0f - 4.0f, 6.0f, 10.0f}, {50.0f + 6.0f, 6.0f, 0.0f}, {50.0f + 10.0f, 10.0f, -100.0f}};
        ...
        RigWellPathStimplanIntersectorTester::testCalculate(
...

    {
...

        {
            std::map<size_t, RigWellPathStimplanIntersector::WellCellIntersection> stimPlanCellIdxToIntersectionInfoMap;
            std::vector<cvf::Vec3d>                                                wellPathPoints = {
                {1.0f, 0.5f, 10.0f}, {1.0f, 1.0f, 0.5f}, {1.0f, 1.5f, -0.5f}, {1.0f, 2.0f, -10.0f}};
