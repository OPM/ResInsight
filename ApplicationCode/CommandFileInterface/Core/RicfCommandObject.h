...
#define RICF_InitFieldTranslated( field, keyword, ricfKeyword, default, uiName, iconResourceName, toolTip, whatsThis ) \
    CAF_PDM_InitField( field,                                                                                          \
                       keyword,                                                                                        \
                       default,                                                                                        \
                       uiName,                                                                                         \
                       iconResourceName,                                                                               \
                       RicfCommandObject::pythonHelpString( toolTip, ricfKeyword ),                                    \
                       whatsThis );                                                                                    \
    AddRicfCapabilityToField( field, ricfKeyword )

#define RICF_InitFieldNoDefaultTranslated( field, keyword, ricfKeyword, uiName, iconResourceName, toolTip, whatsThis ) \
    CAF_PDM_InitFieldNoDefault( field,                                                                                 \
                                keyword,                                                                               \
                                uiName,                                                                                \
                                iconResourceName,                                                                      \
