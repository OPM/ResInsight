                    ...
                    {
                        {
                            ...
                            RigMDCellIdxEnterLeaveKey enterLeaveKey(
                                m_wellPath->m_measuredDepths.front(), globalCellIndex, isEntering);
...

                        {
                            ...
                            RigMDCellIdxEnterLeaveKey enterLeaveKey(
                                m_wellPath->m_measuredDepths.back(), globalCellIndex, isEntering);
