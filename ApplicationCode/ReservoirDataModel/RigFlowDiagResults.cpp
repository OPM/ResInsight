...
///
//--------------------------------------------------------------------------------------------------
void RigFlowDiagResults::mobileVolumeWeightedMean( const RigFlowDiagResultAddress& resVarAddr,
                                                   int                             timeStepIndex,
                                                   double*                         mean )
{
                                                    ...
                                                    int                         maxTof )
{
    ...
    {
        RimFlowDiagSolution::TracerStatusType status = m_flowDiagSolution->tracerStatusInTimeStep( tracerName,
                                                                                                   timeStepIndex );
