...
public:
    ...
    static TransmissibilityData calculateTransmissibilityData(RimEclipseCase*    eclipseCase,
...
private:
    ...
    static void
        exportWelspecsToFile(RimEclipseCase* gridCase, QFilePtr exportFile, const std::vector<RigCompletionData>& completions);
