           ...
           )
{
    ...
    getGridPropertyForSelectedCells(propertyFrames, "127.0.0.1", riOctavePlugin::activePortNumber(), caseId, propertyName.c_str(), requestedTimeSteps, porosityModel.c_str());
