...
from typing import Any, Callable, TypeVar, Tuple, cast, Union, List, Optional
...
class PdmObjectBase:
    ...
    JSONVal = Union[bool, str, float, int, "JSONArray"]
    JSONArray = List[JSONVal]
    # JSONObject = Dict[str, JSONVal]

    def __convert_from_grpc_value(self, value: str) -> JSONVal:
    ...
    def __get_grpc_value(self, camel_keyword: str) -> JSONVal:
    ...
    def __makelist(self, list_string: str) -> JSONVal:
