...
def main():
    ...
    print("- valve_templates.add_template(completion_type='AICD', orifice_diameter=7.3, flow_coefficient=0.2)")
    print("- valve_templates.add_template(completion_type='ICV', user_label='My Custom Template')")
