...
well_path_coll = resinsight.project.descendants(rips.WellPathCollection)
well_path = well_path_coll[0].add_new_object(rips.ModeledWellPath)
...
# Comments
# new_lateral = well_path.append_lateral(tie_in_depth=1000, lateral_name="...")
# rename to append_well_target