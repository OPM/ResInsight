...
def generate_proto_files(proto_directory, output_directory):
    proto_files = [
        file_name
        for file_name in os.listdir(proto_directory)
        if os.path.isfile(os.path.join(proto_directory, file_name))
    ]
...
if __name__ == "__main__":
    ...
    output_directory = os.path.normpath(
        os.path.join(current_directory, "../Python/rips/generated")
    )
