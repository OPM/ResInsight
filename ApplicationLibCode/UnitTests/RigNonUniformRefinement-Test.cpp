...
{
    auto nuRef = RigNonUniformRefinement::fromUniform( cvf::Vec3st( 3, 2, 1 ), 4, 5, 6 );
...
{
    auto nuRef = RigNonUniformRefinement::fromUniform( cvf::Vec3st( 1, 1, 1 ), 3, 3, 3 );
...
{
    RigNonUniformRefinement nuRef( 3, 1, 1 );
...
{
    RigNonUniformRefinement nuRef( 4, 1, 1 );
...
{
    RigNonUniformRefinement nuRef( 1, 1, 1 );
...
{
    RigNonUniformRefinement nuRef( 5, 1, 1 );
...
{
    RigNonUniformRefinement nuRef( 2, 1, 1 );
...
{
    RigNonUniformRefinement nuRef( 3, 2, 1 );
