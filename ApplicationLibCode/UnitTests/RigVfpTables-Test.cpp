...
TEST( RigVfpTables, FieldUnitConversion )
{
    ...
    double convertedFlowRate = RigVfpTables::convertToDisplayUnit( flowRateValue, RimVfpDefines::ProductionVariableType::FLOW_RATE, fieldUnitSystem );
...
TEST( RigVfpTables, MetricUnitConversion )
{
    ...
    double convertedFlowRate = RigVfpTables::convertToDisplayUnit( flowRateValue, RimVfpDefines::ProductionVariableType::FLOW_RATE, metricUnitSystem );
