...
{
    CAF_PDM_InitObject( "Color Legends", ":/Legend.svg" );

    CAF_PDM_InitFieldNoDefault( &m_standardColorLegends, "StandardColorLegends", "Standard Color Legends", ":/Legend.svg" );
    m_standardColorLegends.xmlCapability()->disableIO();

    CAF_PDM_InitFieldNoDefault( &m_customColorLegends, "CustomColorLegends", "Custom Color Legends", ":/Legend.svg" );
}
