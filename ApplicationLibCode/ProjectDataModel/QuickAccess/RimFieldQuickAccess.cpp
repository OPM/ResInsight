...
RimFieldQuickAccess::RimFieldQuickAccess()
{
    ...
    CAF_PDM_InitFieldNoDefault( &m_selectObjectButton, "SelectObject", "...", ":/arrow-swap.svg", "Select Object in Property Editor" );
    ...
    CAF_PDM_InitFieldNoDefault( &m_removeItemButton, "RemoveItem", "...", ":/pinned.svg", "Remove Quick Access" );
