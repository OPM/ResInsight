...
CAF_PDM_XML_ABSTRACT_SOURCE_INIT( RimSingleJob, "SingleJob" ); // Do not use. Abstract class
...
///
//--------------------------------------------------------------------------------------------------
QString RimSingleJob::workingDirectory() const
{
    return "";
}
...
///
//--------------------------------------------------------------------------------------------------
void RimSingleJob::defineObjectEditorAttribute( QString uiConfigName, caf::PdmUiEditorAttribute* attribute )
{
...
///
//--------------------------------------------------------------------------------------------------
bool RimSingleJob::matchesKeyValue( const QString& key, const QString& value ) const
{
    return false;
}