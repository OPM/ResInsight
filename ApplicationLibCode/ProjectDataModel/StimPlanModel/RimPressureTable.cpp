...
///
//--------------------------------------------------------------------------------------------------
void RimPressureTable::insertItem( RimPressureTableItem* insertBefore, RimPressureTableItem* attribute )
{
    size_t index = m_pressureTableItems.index( insertBefore );
    if ( index < m_pressureTableItems.size() )
        m_pressureTableItems.insert( index, attribute );
    else
        m_pressureTableItems.push_back( attribute );
...
///
//--------------------------------------------------------------------------------------------------
void RimPressureTable::deleteItem( RimPressureTableItem* attributeToDelete )
{
    m_pressureTableItems.removeChildObject( attributeToDelete );
