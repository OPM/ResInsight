...
class RimGridSummaryCase_obsolete : public RimSummaryCase
{
    CAF_PDM_HEADER_INIT;

public:
    RimGridSummaryCase_obsolete();
    ~RimGridSummaryCase_obsolete() override;

    static void convertGridCasesToSummaryFileCases( RimProject* project );
...
private:
    ...
    static RimFileSummaryCase* createFileSummaryCaseCopy( const RimGridSummaryCase_obsolete& source );
