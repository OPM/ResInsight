...
RimSummaryPlotSourceStepping::RimSummaryPlotSourceStepping()
    : m_sourceSteppingType( RimSummarySourceSteppingInterface::Axis::Y_AXIS )
{
...
///
//--------------------------------------------------------------------------------------------------
void RimSummaryPlotSourceStepping::setSourceSteppingType( RimSummarySourceSteppingInterface::Axis sourceSteppingType )
{
                                                     ...
                                                     const QVariant&            newValue )
{
    ...
    if ( dataSourceInterface() ) curves = dataSourceInterface()->allCurves( m_sourceSteppingType );
...
std::set<RifEclipseSummaryAddress> RimSummaryPlotSourceStepping::adressesForSourceStepping() const
{
    ...
    if ( dataSourceInterface() )
    {
        ...
        std::vector<RimSummaryCurve*> curves;
        if ( dataSourceInterface() ) curves = dataSourceInterface()->curvesForStepping( m_sourceSteppingType );
...
{
    if ( m_sourceSteppingType == RimSummarySourceSteppingInterface::Axis::UNION_X_Y_AXIS ) return true;

    if ( m_sourceSteppingType == RimSummarySourceSteppingInterface::Axis::X_AXIS ) return true;
...
bool RimSummaryPlotSourceStepping::isYAxisStepping() const
{
    ...
    if ( m_sourceSteppingType == RimSummarySourceSteppingInterface::Axis::Y_AXIS ) return true;
...
///
//--------------------------------------------------------------------------------------------------
RimSummarySourceSteppingInterface* RimSummaryPlotSourceStepping::dataSourceInterface() const
{
    return dynamic_cast<RimSummarySourceSteppingInterface*>( m_objectForSourceStepping.p() );
}
