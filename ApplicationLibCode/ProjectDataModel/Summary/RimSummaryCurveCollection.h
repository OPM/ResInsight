...
public:
    ...
    RimSummaryPlotSourceStepping* sourceSteppingObject( RimSummarySourceSteppingInterface::Axis sourceSteppingType ) const;

    std::vector<RimSummaryCurve*> curves() const;
    std::vector<RimSummaryCurve*> curvesForSourceStepping( RimSummarySourceSteppingInterface::Axis steppingType ) const;
