...
protected:
    ...
    cvf::ref<RigWellPath> createWellPathGeometry( bool useAutoGeneratedTargetAtSeaLevel, double offsetMd ) const;
...
private:
    ...
    RiaLineArcWellPathCalculator lineArcWellPathCalculator( bool useAutoGeneratedTargetAtSeaLevel ) const;
