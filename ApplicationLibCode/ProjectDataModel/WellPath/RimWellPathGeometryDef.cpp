...
cvf::ref<RigWellPath> RimWellPathGeometryDef::createWellPathGeometry()
{
    ...
    return createWellPathGeometry( m_useAutoGeneratedTargetAtSeaLevel, offsetMd );
}
                                                                      ...
                                                                      double offsetMd ) const
{
    ...
    RiaLineArcWellPathCalculator wellPathCalculator = lineArcWellPathCalculator( useAutoGeneratedTargetAtSeaLevel );
...
{
    RiaLineArcWellPathCalculator wellPathCalculator = lineArcWellPathCalculator( m_useAutoGeneratedTargetAtSeaLevel );
    ...
    else if ( changedField == &m_useAutoGeneratedTargetAtSeaLevel )
    {
        ...
        if ( !m_useAutoGeneratedTargetAtSeaLevel() )
        {
            ...
            if ( firstTarget != nullptr )
            {
                ...
                auto wellPathGeo = createWellPathGeometry( true, 0.0 );
...
///
//--------------------------------------------------------------------------------------------------
RiaLineArcWellPathCalculator RimWellPathGeometryDef::lineArcWellPathCalculator( bool useAutoGeneratedTargetAtSeaLevel ) const
{
