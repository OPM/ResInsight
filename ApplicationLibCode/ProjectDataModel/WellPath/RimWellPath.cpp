    ...
    : nameChanged( this )
{
    ...
    CAF_PDM_InitScriptableField( &m_wellPathColor, "WellPathColor", cvf::Color3f( 0.999f, 0.333f, 0.999f ), "Well Path Color" );
...
RimSegmentCollection* RimWellPath::segmentCollection()
{
    ...
    if ( const auto* topLevelWell = topLevelWellPath(); topLevelWell && topLevelWell != this )
    {
        collection->updateFromTopLevelWell( topLevelWell->segmentCollection() );
    }
    return collection;
}
