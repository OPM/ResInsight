...
bool RiaResultNames::isCategoryResult( const QString& resultName )
{
    ...
    if ( resultName.compare( RiaResultNames::nestId(), Qt::CaseInsensitive ) == 0 ) return true;
...
///
//--------------------------------------------------------------------------------------------------
QString RiaResultNames::opernum()
{
    return "OPERNUM";
}
...
///
//--------------------------------------------------------------------------------------------------
QString RiaResultNames::bordnum()
{
    return "BORDNUM";
}
...
///
//--------------------------------------------------------------------------------------------------
QString RiaResultNames::satnumResult()
{
    return "SATNUM";
}
...
///
//--------------------------------------------------------------------------------------------------
QString RiaResultNames::imbnumResult()
{
    return "IMBNUM";
}
