...
///
//--------------------------------------------------------------------------------------------------
bool RicWellPathImportPerforationIntervalsFeature::isCommandEnabled() const {if ( RicWellPathImportPerforationIntervalsFeature::selectedWellPathCollection() != nullptr )
    {
        return true;
    }
