                                                                             ...
                                                                             int                    timeStep )
{
    ...
    auto exportInfo    = std::make_unique<RicMswExportInfo>( wellPath,
                                                          unitSystem,
                                                          initialMD,
                                            ...
                                            exportInfo->mainBoreBranch() ) )
    {
        ...
        assignBranchNumbersToBranch( eclipseCase, exportInfo.get(), exportInfo->mainBoreBranch(), &branchNumber );
