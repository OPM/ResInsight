...
{
    const auto caseSelection     = caf::SelectionManager::instance()->objectsByType<RimCase>();
    const auto caseCollSelection = caf::SelectionManager::instance()->objectsByType<RimEclipseCaseCollection>();
