...
{
    actionToSetup->setText( "Apply User Defined Camera" );
    actionToSetup->setIcon( QIcon( ":/UpView.svg" ) );
    applyShortcutWithHintToAction( actionToSetup, QKeySequence( tr( "Ctrl+Alt+C" ) ) );
}
