...
///
//--------------------------------------------------------------------------------------------------
void RiuQwtCurvePointTracker::enableHorizontalLine()
{
    m_plotMarker->setLineStyle( QwtPlotMarker::HLine );
}

//--------------------------------------------------------------------------------------------------
///
//--------------------------------------------------------------------------------------------------
void RiuQwtCurvePointTracker::enableVerticalLine()
{
...
///
//--------------------------------------------------------------------------------------------------
void RiuQwtCurvePointTracker::disableLines()
{
    m_plotMarker->setLineStyle( QwtPlotMarker::NoLine );
}
