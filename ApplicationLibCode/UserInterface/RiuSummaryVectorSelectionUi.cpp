...
public:
    SummaryIdentifierAndField()
        : m_summaryIdentifier( (RifEclipseSummaryAddressDefines::SummaryIdentifierType)0 )
        , m_pdmField( nullptr )
    {
    }
    ...
    SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType summaryIdentifier )
...
RiuSummaryVectorSelectionUi::RiuSummaryVectorSelectionUi()
    : m_identifierFieldsMap( {
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_FIELD,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_AQUIFER,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_AQUIFER_NUMBER ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_NETWORK,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_NETWORK_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_MISC,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_REGION_NUMBER ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION_2_REGION,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_REGION_2_REGION ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_GROUP,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_GROUP_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_WELL_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_WELL_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_CELL_IJK ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION_LGR,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_LGR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_WELL_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_CELL_IJK ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_LGR,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_LGR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_WELL_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_WELL_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_SEGMENT_NUMBER ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_CELL_IJK ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK_LGR,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_LGR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_CELL_IJK ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
          { RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_IMPORTED,
            { new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME ),
              new SummaryIdentifierAndField( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID ) } },
    ...
    , m_showIndividualEnsembleCases( true )
{
    ...
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_AQUIFER][1]->pdmField(),
                                "AquiferVectors",
                                "Aquifer Vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_AQUIFER][2]->pdmField(),
    ...
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_NETWORK][1]->pdmField(),
                                "NetworkVectors",
                                "Network Vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_NETWORK][2]->pdmField(),
    ...
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION][1]->pdmField(),
                                "RegionsVectors",
                                "Regions Vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION][2]->pdmField(),
                                "RegionCalculationIds",
                                "Calculation Ids" );

    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION_2_REGION][0]->pdmField(),
                                "Region2RegionRegions",
                                "Regions" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION_2_REGION][1]->pdmField(),
                                "Region2RegionVectors",
                                "Region2s Vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION_2_REGION][2]->pdmField(),
                                "Region2RegionCalculationIds",
                                "Calculation Ids" );

    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_GROUP][0]->pdmField(),
                                "WellGroupWellGroupNames",
                                "Groups" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_GROUP][1]->pdmField(),
                                "WellGroupVectors",
                                "Well Group Vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_GROUP][2]->pdmField(),
    ...
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION][0]->pdmField(),
                                "WellCompletionWellName",
                                "Wells" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION][1]->pdmField(),
                                "WellCompletionIjk",
                                "Cell IJK" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION][2]->pdmField(),
                                "WellCompletionVectors",
                                "Well Completion Vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION][3]->pdmField(),
                                "WellCompletionCalculationIds",
                                "Calculation Ids" );

    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION_LGR][0]->pdmField(),
                                "WellCompletionLgrLgrName",
                                "LGR Names" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION_LGR][1]->pdmField(),
                                "WellCompletionLgrWellName",
                                "Wells" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION_LGR][2]->pdmField(),
                                "WellCompletionLgrIjk",
                                "Cell IJK" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION_LGR][3]->pdmField(),
                                "WellCompletionLgrVectors",
                                "Well Completion Vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION_LGR][4]->pdmField(),
    ...
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT][0]->pdmField(),
                                "WellSegmentWellName",
                                "Wells" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT][1]->pdmField(),
                                "WellSegmentNumber",
                                "Segments" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT][2]->pdmField(),
                                "WellSegmentVectors",
                                "Vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT][3]->pdmField(),
    ...
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK_LGR][2]->pdmField(),
                                "BlockLgrVectors",
                                "Block Vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK_LGR][3]->pdmField(),
                                "BlockLgrCalculationIds",
                                "CalculationIds" );

    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_IMPORTED][0]->pdmField(),
                                "ImportedVectors",
                                "Imported vectors" );
    CAF_PDM_InitFieldNoDefault( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_IMPORTED][1]->pdmField(),
...
void RiuSummaryVectorSelectionUi::setSelectedCurveDefinitions( const std::vector<RiaSummaryCurveDefinition>& curveDefinitions )
{
    ...
    std::set<RifEclipseSummaryAddressDefines::SummaryVarCategory> categories;
    for ( const auto& curveDef : curveDefinitions )
    {
        ...
        if ( summaryAddress.category() == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_ENSEMBLE_STATISTICS ) continue;
        ...
        {
            if ( summaryAddress.category() != RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_INVALID )
            {
    ...
    if ( !categories.empty() )
    {
        RifEclipseSummaryAddressDefines::SummaryVarCategory cat = *( categories.begin() );
...
void RiuSummaryVectorSelectionUi::fieldChangedByUi( const caf::PdmFieldHandle* changedField, const QVariant& oldValue, const QVariant& newValue )
{
    ...
    {
        RifEclipseSummaryAddressDefines::SummaryVarCategory currentCategory = m_currentSummaryCategory();
        if ( currentCategory != RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_INVALID )
        {
...
void RiuSummaryVectorSelectionUi::defineUiOrdering( QString uiConfigName, caf::PdmUiOrdering& uiOrdering )
{
    ...
    RifEclipseSummaryAddressDefines::SummaryVarCategory sumCategory = m_currentSummaryCategory();
    if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_INVALID )
    {
        sumCategory = RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_FIELD;
    }

    if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_FIELD )
    {
        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_FIELD][0]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_AQUIFER )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( RiaDefines::summaryAquifer() + "s" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_AQUIFER][0]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_AQUIFER][1]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_NETWORK )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( RiaDefines::summaryNetwork() + "s" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_NETWORK][0]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_NETWORK][1]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_MISC )
    {
        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_MISC][0]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( RiaDefines::summaryRegion() + "s" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION][0]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION][1]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION_2_REGION )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( "Regions" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION_2_REGION][0]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION_2_REGION][1]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_GROUP )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( RiaDefines::summaryWellGroup() + "s" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_GROUP][0]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_GROUP][1]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( RiaDefines::summaryWell() + "s" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL][0]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL][1]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( RiaDefines::summaryCompletion() + "s" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION][0]->pdmField() );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION][1]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION][2]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION_LGR )
    {
        {
    ...
    {
        {
            ...
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_LGR][0]->pdmField() );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_LGR][1]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_LGR][2]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( RiaDefines::summaryWellSegment() + "s" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT][0]->pdmField() );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT][1]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT][2]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( RiaDefines::summaryBlock() + "s" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK][0]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK][1]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK_LGR )
    {
        {
            caf::PdmUiGroup* myGroup = uiOrdering.addNewGroup( RiaDefines::summaryLgrBlock() + "s" );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK_LGR][0]->pdmField() );
            myGroup->add( m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK_LGR][1]->pdmField() );
        }

        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK_LGR][2]->pdmField();
    }
    else if ( sumCategory == RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_IMPORTED )
    {
        summaryiesField = m_identifierFieldsMap[RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_IMPORTED][0]->pdmField();
    }
...
std::set<RifEclipseSummaryAddress> RiuSummaryVectorSelectionUi::buildAddressListFromSelections() const
{
    ...
    for ( const auto& category : m_selectedSummaryCategories() )
    {
        ...
        std::vector<std::pair<RifEclipseSummaryAddressDefines::SummaryIdentifierType, QString>> selectionStack;
...

{
    for ( const auto& identifierText : ( *identifierAndFieldItr )->pdmField()->v() )
    {
        ...
        if ( ( *identifierAndFieldItr )->summaryIdentifier() == RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_VECTOR_NAME )
        {
            ...
            if ( tokens.size() > 1 )
            {
                ...
                identifierPath.push_back( std::make_pair( RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_ID, calculationId ) );
            }
        }
        ...
        {
            std::map<RifEclipseSummaryAddressDefines::SummaryIdentifierType, std::string> selectedIdentifiers;
...
void RiuSummaryVectorSelectionUi::resetAllFields()
{
    ...
    m_selectedSummaryCategories = std::vector<caf::AppEnum<RifEclipseSummaryAddressDefines::SummaryVarCategory>>();
...
{
    std::vector<RifEclipseSummaryAddressDefines::SummaryVarCategory> sortedCategoriesForUi;

    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_FIELD );
    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_AQUIFER );
    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_NETWORK );
    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_MISC );
    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION );
    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_REGION_2_REGION );
    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_GROUP );
    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL );
    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION );
    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK );

    if ( !m_hideCalculationIncompatibleCategories )
    {
        sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_SEGMENT );
        sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_LGR );
        sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_WELL_COMPLETION_LGR );
        sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_BLOCK_LGR );
    }

    sortedCategoriesForUi.push_back( RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_IMPORTED );

    // NB SUMMARY_ENSEMBLE_STATISTICS is intentionally excluded
    // categoriesForUiDisplay.push_back(RifEclipseSummaryAddressDefines::SummaryVarCategory::SUMMARY_ENSEMBLE_STATISTICS);
                                                                               ...
                                                                               SummaryIdentifierAndField*     identifierAndField ) const
{
    ...
    for ( int i = 0; i < itemCount; i++ )
    {
        ...
        std::vector<std::string> itemNamesVector;
        {
            ...
            {
                case RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_REGION_NUMBER:
                case RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_SEGMENT_NUMBER:
                case RifEclipseSummaryAddressDefines::SummaryIdentifierType::INPUT_AQUIFER_NUMBER:
                {
                    std::set<int> values;
