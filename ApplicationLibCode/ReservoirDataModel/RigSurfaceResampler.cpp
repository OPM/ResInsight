                                         ...
                                         cvf::Vec3d&       intersectionPoint )
{
    ...
    surface->findIntersectingTriangles( bb, &itemIndices );
    ...
    {
        for ( auto itemIndex : itemIndices )
        {
            bool isLineDirDotNormalNegative = false;
            if ( cvf::GeometryTools::intersectLineSegmentTriangle( pointAbove,
                                                                   pointBelow,
                                                                   vertices[indices[itemIndex * 3 + 0]],
                                                                   vertices[indices[itemIndex * 3 + 1]],
                                                                   vertices[indices[itemIndex * 3 + 2]],
                                                                   &intersectionPoint,
