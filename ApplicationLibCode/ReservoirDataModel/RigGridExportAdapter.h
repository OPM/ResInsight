...
public:
    ...
    size_t cellCountI() const { return m_refinedNI; }
    size_t cellCountJ() const { return m_refinedNJ; }
    size_t cellCountK() const { return m_refinedNK; }
    size_t totalCells() const { return m_refinedNI * m_refinedNJ * m_refinedNK; }
    ...
    cvf::Vec3st originalMin() const { return m_min; }
    cvf::Vec3st originalMax() const { return m_max; }
    cvf::Vec3st refinement() const { return m_refinement; }
    bool        hasRefinement() const { return m_refinement.x() > 1 || m_refinement.y() > 1 || m_refinement.z() > 1; }
