...
public:
    ...
    RigNonUniformRefinement( size_t sectorSizeI, size_t sectorSizeJ, size_t sectorSizeK );
    ...
    static RigNonUniformRefinement fromUniform( const cvf::Vec3st& refinement, size_t sectorSizeI, size_t sectorSizeJ, size_t sectorSizeK );
