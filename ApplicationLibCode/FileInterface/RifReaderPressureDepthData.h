...
public:
    ...
    // static QStringList findSubDirectoriesWithPressureDepthDataData( const QString& filePath );
    // static bool        directoryContainsPressureDepthDataData( const QString& filePath );
