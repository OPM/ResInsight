...
DIFFMICP::DIFFMICP() : ParserKeyword("DIFFMICP", KeywordSize("TABDIMS", "NTPVT", false, 0)) {
  addValidSectionName("PROPS");
  setRequiredKeywords({
    "MICP",
  });
  clearDeckNames();
  addDeckName("DIFFMICP");
  {
     ParserRecord record;
     {
        ParserItem item("DATA", ParserItem::itype::DOUBLE);
...
const std::string DIFFMICP::keywordName = "DIFFMICP";
const std::string DIFFMICP::DATA::itemName = "DATA";
