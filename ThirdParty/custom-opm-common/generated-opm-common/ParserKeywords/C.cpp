...
CONNECTION_PROBE_OPM::CONNECTION_PROBE_OPM() : ParserKeyword("CONNECTION_PROBE_OPM", KeywordSize(SLASH_TERMINATED)) {
  ...
  addDeckName("CFRPMAX");
  addDeckName("CFRPAVG");
  addDeckName("CFRIRMAX");
  addDeckName("CFRIRMIN");
  addDeckName("CFRIRAVG");
  addDeckName("CFRIRSTD");
  addDeckName("CFRWDMAX");
  addDeckName("CFRWDMIN");
  addDeckName("CMUPR");
  addDeckName("CFRWDSTD");
  addDeckName("CMUIR");
  addDeckName("CMMITL");
  addDeckName("CMUIT");
  addDeckName("CMUPRL");
...
CSTRESS::CSTRESS() : ParserKeyword("CSTRESS", KeywordSize(1, false)) {
  addValidSectionName("GRID");
  clearDeckNames();
  addDeckName("CSTRESS");
  {
...
const std::string CSTRESS::keywordName = "CSTRESS";
const std::string CSTRESS::data::itemName = "data";
