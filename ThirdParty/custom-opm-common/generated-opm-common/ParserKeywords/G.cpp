...
GCONPROD::GCONPROD() : ParserKeyword("GCONPROD", KeywordSize(SLASH_TERMINATED)) {
  ...
  addDeckName("GCONPROD");
  {
     ...
     {
        ParserItem item("RESERVOIR_FLUID_TARGET", ParserItem::itype::UDA);
        item.push_backDimension("ReservoirVolume/Time");
        record.addItem(item);
     }
     {
...
GEFAC::GEFAC() : ParserKeyword("GEFAC", KeywordSize(SLASH_TERMINATED)) {
  ...
  addDeckName("GEFAC");
  {
     ...
     {
        ParserItem item("USE_GEFAC_IN_NETWORK", ParserItem::itype::STRING);
        item.setDefault( std::string("YES") );
        record.addItem(item);
     }
     addRecord( record );
...
const std::string GEFAC::USE_GEFAC_IN_NETWORK::itemName = "USE_GEFAC_IN_NETWORK";
const std::string GEFAC::USE_GEFAC_IN_NETWORK::defaultValue = "YES";
