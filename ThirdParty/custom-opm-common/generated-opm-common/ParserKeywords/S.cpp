...
STREQUIL::STREQUIL() : ParserKeyword("STREQUIL", KeywordSize(SLASH_TERMINATED)) {
  ...
  addDeckName("STREQUIL");
  {
     ...
     {
        ParserItem item("STRESSXY", ParserItem::itype::DOUBLE);
        item.push_backDimension("Pressure");
        record.addItem(item);
     }
     {
        ParserItem item("STRESSXYGRAD", ParserItem::itype::DOUBLE);
        item.push_backDimension("Pressure/Length");
        record.addItem(item);
     }
     {
        ParserItem item("STRESSXZ", ParserItem::itype::DOUBLE);
        item.push_backDimension("Pressure");
        record.addItem(item);
     }
     {
        ParserItem item("STRESSXZGRAD", ParserItem::itype::DOUBLE);
        item.push_backDimension("Pressure/Length");
        record.addItem(item);
     }
     {
        ParserItem item("STRESSYZ", ParserItem::itype::DOUBLE);
        item.push_backDimension("Pressure");
        record.addItem(item);
     }
     {
        ParserItem item("STRESSYZGRAD", ParserItem::itype::DOUBLE);
        item.push_backDimension("Pressure/Length");
        record.addItem(item);
     }
     addRecord( record );
...
const std::string STREQUIL::STRESSXY::itemName = "STRESSXY";
const std::string STREQUIL::STRESSXYGRAD::itemName = "STRESSXYGRAD";
const std::string STREQUIL::STRESSXZ::itemName = "STRESSXZ";
const std::string STREQUIL::STRESSXZGRAD::itemName = "STRESSXZGRAD";
const std::string STREQUIL::STRESSYZ::itemName = "STRESSYZ";
const std::string STREQUIL::STRESSYZGRAD::itemName = "STRESSYZGRAD";
