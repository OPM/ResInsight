...
/// 
//--------------------------------------------------------------------------------------------------
bool ExpressionParser::expandStatementsAndEvaluate(const QString& expressionText, QString* errorText /*= nullptr*/)
{
    QString expandedExpressionText = ExpressionParserImpl::expandStatements(expressionText);
